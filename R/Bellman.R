  ...
  #' @param max_mcyearNumeric of length 1. Number of Monte-Carlo year
  #'  used in simulations
  ...
  #' @param parallel_mode Boolean. True o use parallel computing.
  ...
  #----- little test -----
    ...
    if(parallel_mode){
      ...
      VB <- foreach::foreach (i=1:nrow(Data_week),.combine = 'c') %dopar%{

...
calculate_Bellman_value <- function(states, states_next, value_reward, value_inflow, decision_space,
  ...
  # respect the guide graph co,sstraints
  ...
  if (method == "mean-grid") {
    return(max(temp, na.rm = TRUE))
  } else {
    return(mean_finite(temp))
  }

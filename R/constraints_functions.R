...
#' @param inflow Weekly inflow, generated by \code{get_inflow()}.
#'
...
#' @keywords internal
constraint_week <- function(pumping,efficiency,nb_disc_stock,res_cap,hydro,week){
  maxi <- min(hydro$turb,res_cap+hydro$max_app)
  mini <- max(-res_cap,-hydro$pump*efficiency)

...
get_Reward <- function(simulation_values = NULL,simulation_names=NULL, pattern = NULL,
  ...
  if(method_old){
    ...
    {reward <- lapply(
      X = opts_o,
      FUN = function(o) {
        res <- get_weekly_cost(district = district_name, mcyears = mcyears, opts = o, expansion = expansion)
    ...
    {reward <- mapply(
      FUN = function(o,u) {
        ...
        res <- reward_offset(o,res, u[[1]],mcyears,district_name, expansion=expansion)

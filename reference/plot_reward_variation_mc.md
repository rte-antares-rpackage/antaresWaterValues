...
Plot variation of reward functions for different weeks listed in
`weeks_to_plot` and different scenarios listed in `scenarios_to_plot`.

## Usage

``` r
plot_reward_variation_mc(reward_base, weeks_to_plot, scenarios_to_plot)
```
